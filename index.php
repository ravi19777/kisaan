...
mysqli_select_db($con,'hamkisaan');
$name=$_POST['name'];
...
$sql="INSERT INTO `member_details` (`name`, `father_name`, `phone`, `village`, `block`, `district`, `state`, `user_name`, `password`) 
VALUES ($name', '$fathername', '$phone', '$village', '$block', '$district', '$state', '$user_name', '$password'";
echo $sql;
...
<div class="modal fade" id="signupBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control my-2"  name="name" placeholder="नाम*">
    <input type="text" class="form-control my-2"  name="fathername" placeholder="पिता का नाम *">
    <input type="number" class="form-control my-2"  name="phone" placeholder="फोन नंबर *">
    <input type="text" class="form-control my-2"  name="village" placeholder="गाँव *">
    <input type="text" class="form-control my-2"  name="block" placeholder="प्रखण्ड *">
    <input type="text" class="form-control my-2"  name="district" placeholder="जिला *">
    <input type="text" class="form-control my-2"  name="state" placeholder="राज्य *">
